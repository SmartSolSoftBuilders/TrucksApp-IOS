...
//Rare exceptions to indicate a bug in the _radarfoodtruck code (Eg, function that a subclass should have implemented)
...
/**
 The base class for RadarFoodTruck proxies.
 */
