...
/**
 Base class for all RadarFoodTruck views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RadarFoodTruck view hierarchy (such as wrapped iOS UIViews) was touched.
