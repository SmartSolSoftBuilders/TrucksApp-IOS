...
// in simulator we redefine to format for RadarFoodTruck Developer console
...
{\
	NSString * exceptionName = [@"org.radarfoodtruck." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.radarfoodtruck";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRadarFoodTruckNativeItemNone = -1, 
	UIRadarFoodTruckNativeItemSpinner = -2,
	UIRadarFoodTruckNativeItemProgressBar = -3,
	
	UIRadarFoodTruckNativeItemSlider = -4,
	UIRadarFoodTruckNativeItemSwitch = -5,
	UIRadarFoodTruckNativeItemMultiButton = -6,
	UIRadarFoodTruckNativeItemSegmented = -7,
	
	UIRadarFoodTruckNativeItemTextView = -8,
	UIRadarFoodTruckNativeItemTextField = -9,
	UIRadarFoodTruckNativeItemSearchBar = -10,
	
	UIRadarFoodTruckNativeItemPicker = -11,
	UIRadarFoodTruckNativeItemDatePicker = -12,
	
	UIRadarFoodTruckNativeItemInfoLight = -13,
	UIRadarFoodTruckNativeItemInfoDark = -14,
	
	UIRadarFoodTruckNativeItemDisclosure = -15,
	
	UIRadarFoodTruckNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RadarFoodTruck instances of
