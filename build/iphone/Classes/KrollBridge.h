...
@interface RadarFoodTruckObject : KrollCoverageObject {
#else
@interface RadarFoodTruckObject : KrollObject {
#endif
@private
...
extern NSString * RadarFoodTruck$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	RadarFoodTruckObject *_radarfoodtruck;
    KrollObject* console;
	BOOL shutdown;
