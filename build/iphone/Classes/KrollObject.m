...
//@interface RadarFoodTruckObject : NSObject
//@end

@interface RadarFoodTruckObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RadarFoodTruckObject class]])
		{
			for (NSString *key in [[(RadarFoodTruckObject*)o modules] allKeys])
			{
